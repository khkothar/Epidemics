...
public class EpidemicWordFilesReader {
	...
	public double readEpidemicWordFiles(String inputFile1, String inputFile2) throws IOException { 
...
//			System.out.println("Line 2 : " + line2);
	...
	public static void main(String[] args) throws Exception{
		...
		double similarity = t.readEpidemicWordFiles("InputCSVs/1.csv", "InputCSVs/2.csv");
